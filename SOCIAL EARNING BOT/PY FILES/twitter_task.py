...
async def X_Task_Bot(page,task,task_url):
    ...
    if new_pages:
        ...
        if 'X/Page Follow'.lower() in task.lower():
            ...
            await new_tab.waitForSelector('button[aria-label*="Like"][data-testid="like"]')
            ...
            await asyncio.sleep(3)
            await css_click_center(new_tab,'div[data-testid="tweetTextarea_0"]')
            await asyncio.sleep(2)
            combox = await new_tab.waitForSelector('div[data-testid="tweetTextarea_0"]')
            await combox.click()
            await asyncio.sleep(2)
            await combox.click()

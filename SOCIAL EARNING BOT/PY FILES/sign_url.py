...
from func import save_daily_csv,saving_files,save_daily_csv2,main_date,xpath_click_center,input_dialog,create_dir,delet_dir_cont
...
async def sign_in(page):
    ...
    if time_diff >=5:
        email_info,pass_info = input_dialog()
